...
import { IoMdSend } from "react-icons/io"; // Import from react-icons/io
  ...
  return (
    <div style={{ backgroundImage: `url(${backgroundImage})` }} className='bg-no-repeat bg-cover'>
      ...
      <section className='h-16 bg-white flex items-center px-4'>
        ...
        <form className='flex-grow mx-3 relative'>
          <input
            className='rounded-full h-11 bg-slate-100 border-none w-full outline-none px-4 py-2'
            name='message'
            value={message.text}
        ...
        <button onClick={handleSendMessage} className='cursor-pointer flex justify-center items-center w-11 h-11 rounded-full bg-primary text-white'>
          <IoMdSend size={22} />
        </button>
      </section>
    </div>
